<script lang="ts" module>
	...
	const PATHS: Record<string, string> = {
		...
		briefcase:
			'M9 7V5.5A1.5 1.5 0 0 1 10.5 4h3A1.5 1.5 0 0 1 15 5.5V7M5.5 7h13A1.5 1.5 0 0 1 20 8.5v10a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 18.5v-10A1.5 1.5 0 0 1 5.5 7ZM4 12.5h16',
		chart: 'M4 4v15.5a.5.5 0 0 0 .5.5H20M8 16v-4m4 4V8m4 8v-6'
	};
