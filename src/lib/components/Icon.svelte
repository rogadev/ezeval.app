<script lang="ts" module>
	...
	const PATHS: Record<string, string> = {
		today:
			'M8 2v4M16 2v4M3.5 9h17M5 4.5h14a1.5 1.5 0 0 1 1.5 1.5v13a1.5 1.5 0 0 1-1.5 1.5H5A1.5 1.5 0 0 1 3.5 19V6A1.5 1.5 0 0 1 5 4.5Z',
		...
		trash:
			'M4 7h16M10 11v6m4-6v6M6 7l1 13a1.5 1.5 0 0 0 1.5 1.3h7A1.5 1.5 0 0 0 17 20l1-13M9 7V4.5A1.5 1.5 0 0 1 10.5 3h3A1.5 1.5 0 0 1 15 4.5V7',
		back: 'M15 5l-7 7 7 7',
		settings:
		...
		workflow: 'M5 5.5h4v4H5v-4Zm10 9h4v4h-4v-4Zm-8-5v3A2.5 2.5 0 0 0 9.5 15H15M9 7.5h8.5',
		billing:
